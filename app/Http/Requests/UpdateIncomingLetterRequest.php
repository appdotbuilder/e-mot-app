...
class UpdateIncomingLetterRequest extends FormRequest
{
    ...
    {
        return [
            'registration_number' => 'required|string|max:255|unique:incoming_letters,registration_number,' . $this->route('incoming_letter')->id,
    ...
    public function messages(): array
    {
        return [
            ...
            'registration_number.unique' => 'Nomor Register sudah digunakan oleh surat lain.',
